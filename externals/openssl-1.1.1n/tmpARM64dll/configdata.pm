...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\00-base-templates.conf", "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\10-main.conf", "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\50-win-onecore.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
...
our %target = (
  ...
  MT => "mt",
  MTFLAGS => "-nologo",
  RANLIB => "CODE(0x297c648)",
  RC => "rc",
  _conf_fname_int => [ "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\00-base-templates.conf", "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\00-base-templates.conf", "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\10-main.conf", "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\10-main.conf", "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\50-win-onecore.conf", "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\shared-info.pl" ],
