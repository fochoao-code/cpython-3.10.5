...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\00-base-templates.conf", "C:\\cpython-3.10.5\\externals\\openssl-1.1.1n\\Configurations\\10-main.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
